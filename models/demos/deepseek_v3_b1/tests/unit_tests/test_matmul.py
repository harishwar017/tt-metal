...
SDPA (bfloat16 in0, bfloat16 in1):
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # SDPA (bfloat16 srcB/in0, bfloat16 srcA/in1)
        (8, 576, 256, ttnn.bfloat16, ttnn.bfloat16),  # SDPA Q @ K.T (KV_chunk_size=256)
        (8, 576, 512, ttnn.bfloat16, ttnn.bfloat16),  # SDPA Q @ K.T (KV_chunk_size=512)
        (8, 256, 512, ttnn.bfloat16, ttnn.bfloat16),  # SDPA S @ V (KV_chunk_size=256)
        (8, 512, 512, ttnn.bfloat16, ttnn.bfloat16),  # SDPA S @ V (KV_chunk_size=512)
