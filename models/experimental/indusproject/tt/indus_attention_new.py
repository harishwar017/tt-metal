...
class TtCausalSelfAttention(nn.Module):
    ...
    def forward_prefill(self, x):
        ...
        # ttnn.dump_tensor(file_name="/tt-metal/models/experimental/indusproject/kv/keys_before_fill.tensorbin", tensor=keys)
        # ttnn.dump_tensor(file_name="/tt-metal/models/experimental/indusproject/kv/values_before_fill.tensorbin", tensor=values)

        # ttnn.dump_tensor(file_name="/tt-metal/models/experimental/indusproject/kv/k_before_fill.tensorbin", tensor=k)
        # ttnn.dump_tensor(file_name="/tt-metal/models/experimental/indusproject/kv/v_before_fill.tensorbin", tensor=v)
        ...
        ttnn.dump_tensor(
            file_name="/tt-metal/models/experimental/indusproject/kv/keys_after_fill.tensorbin", tensor=keys
        )
        ttnn.dump_tensor(
            file_name="/tt-metal/models/experimental/indusproject/kv/values_after_fill.tensorbin", tensor=values
        )
