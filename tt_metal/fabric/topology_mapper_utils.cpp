...
std::map<MeshId, LogicalAdjacencyMap> build_adjacency_map_logical(const ::tt::tt_fabric::MeshGraph& mesh_graph) {
    ...
    for (const auto& mesh_id : mesh_graph.get_all_mesh_ids()) {
        ...
        if (is_1d) {
            ...
            ::tt::tt_fabric::MeshShape mesh_shape = mesh_graph.get_mesh_shape(mesh_id);
            ::tt::tt_fabric::LogicalTopologyTranslator translator(mesh_shape, fabric_config);
            ...
            for (const auto& [_, chip_id] : mesh_graph.get_chip_ids(mesh_id)) {
                ...
                auto east_neighbor = translator.get_logical_neighbor(chip_id, ::tt::tt_fabric::RoutingDirection::E);
                ...
                auto west_neighbor = translator.get_logical_neighbor(chip_id, ::tt::tt_fabric::RoutingDirection::W);
