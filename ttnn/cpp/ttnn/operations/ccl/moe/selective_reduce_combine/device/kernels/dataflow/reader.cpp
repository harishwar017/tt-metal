...
void kernel_main() {
    ...
    constexpr uint32_t dense_data_cb_id = get_named_compile_time_arg_val
    constexpr uint32_t dense_metadata_cb_id = get_named_compile_time_arg_val
    
    constexpr uint32_t metadata_entry_size =get_named_compile_time_arg_val
