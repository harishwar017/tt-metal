...
void kernel_main() {
    constexpr uint32_t metadata_cb_id = get_compile_time_arg_val(0); //global cb
    constexpr uint32_t data_cb_id = get_compile_time_arg_val(1); // global cb
    ...
    constexpr uint32_t core_id_x = ...
    constexpr uint32_t core_id_y = ...
    
    constexpr uint32_t sync_core_noc_x = ...
    constexpr uint32_t sync_core_noc_y = ...
    constexpr bool is_sync_core  
    
    constexpr uint32_t num_token_parallel_cores ...
    constexpr uint32_t num_data_parallel_cores... 
    constexpr uint32_t token_size_bytes = get_compile_time_arg_val(10);  // hidden dim * datum size
    
    constexpr uint32_t token_segment_size_bytes = 
    constexpr uint32_t token_segment_offset_bytes =  
    ...
    constexpr auto output_ta_args = TensorAccessorArgs<18>();    
    ...
    constexpr uint32_t num_tokens_total;  // global token size
    ...
    // read dense token counts, figure out tokens per worker core
